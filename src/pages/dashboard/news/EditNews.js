...
const EditNews = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAlert({ type: 'danger', message: 'Update news failed!', show: true });
        }
    };
    ...
    return (
        <div>
            ...
            <Card>
                <Card.Header>
                    <Card.Title>Edit News</Card.Title>
                </Card.Header>
                <Card.Body>
                        ...
                        <Row>
                            <Col md={12}>
                                <Form.Group controlId="formImageContent">
                                    ...
                                    {!imagePreview ?
                                        <Image style={{ marginBottom: 20 }} src={`${BASE_URL}/uploads/news/${formData.image_content}`} rounded />
                                        :
